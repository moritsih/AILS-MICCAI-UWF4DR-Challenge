...
class OriginalDataset:
    ...
    def _merge_all_data_into_global_df(self):
        ...
        task1_dir = Path(PROJ_ROOT / 'data' / 'raw' / 'Task 1 Image Quality Assessment')
        task23_dir = Path(PROJ_ROOT / 'data' / 'raw' / 'Task 2 Referable DR and Task 3 DME')
...
class DeepDridDataset:
    def __init__(self):
        ...
        deepdrid_path = Path(PROJ_ROOT) / 'data' / 'external' / 'DeepDRiD' / 'ultra-widefield_images'
...
class GetDatasetsByTask:
    ...
    def __init__(self, dataset: str = 'all', task: str = 'full'):
