...
class model:
    def __init__(self):
        self.checkpoint = "ShuffleNetv2_weights_2024-07-31_valiant-sweep-3.pth"  # The checkpoint file path will be replaced in the copied model file - see SubmissionBuilder#CHECK_POINT_FILE_PATH_PLACEHOLDER
    ...
    def load(self, dir_path):
        ...
        :return:
        """
        self.model = build_shufflenet_model()
        # join paths
