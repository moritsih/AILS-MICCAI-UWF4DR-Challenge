...
class model:
    def __init__(self):
        self.checkpoint = "Resnet50_weights_2024-07-29_iconic-sweep-1.pth"  # The checkpoint file path will be replaced in the copied model file - see SubmissionBuilder#CHECK_POINT_FILE_PATH_PLACEHOLDER
    ...
    def load(self, dir_path):
        ...
        :return:
        """
        self.model = build_resnet50_model()
        # join paths
