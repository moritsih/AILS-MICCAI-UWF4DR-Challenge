...
class model:
    def __init__(self):
        self.checkpoint = "ResNet18_weights_2024-07-30_eternal-sweep-2.pth"  # The checkpoint file path will be replaced in the copied model file - see SubmissionBuilder#CHECK_POINT_FILE_PATH_PLACEHOLDER
